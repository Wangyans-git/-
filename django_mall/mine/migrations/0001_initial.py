# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2020-04-13 16:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.FloatField(verbose_name='购买总额')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buy_amount', models.FloatField(verbose_name='购买总价')),
                ...
                ('to_phone', models.CharField(max_length=32, verbose_name='收货人电话')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order', to='accounts.User')),
            ],
            options={
                'db_table': 'mine_order',
            },
        ...
        migrations.AddField(
            model_name='cart',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cart', to='accounts.User'),
        ),
    ]
